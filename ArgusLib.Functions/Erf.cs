...
http://git.musl-libc.org/cgit/musl/tree/src/math/erf.c?h=v1.1.16
*/
...
namespace ArgusLib
{
    public static partial class Functions
	{
		...
		static double erfc2(uint ix, double x)
		{
			#region Constants
			const double
