...
http://git.musl-libc.org/cgit/musl/tree/src/math/log2.c?h=v1.1.16
*/
...
namespace ArgusLib
{
	public static partial class Functions
	{
		...
		public static double Log2(double x)
		{
			...
			else if (hx == 0x3ff00000 && u.LowWord == 0)
				return 0;
			...
			u.Bits = (ulong)hx << 32 | (u.Bits & 0xffffffff);
			x = u.Value;
