...
//		public static int RowCount { get { return ColumnDimension; } }
//		public static int ColumnCount { get { return RowDimension; } }
//		public static int DiagonalElementCount { get { return Math.Min(RowDimension, ColumnDimension); } }
//		public static int ElementCount { get { return RowDimension * ColumnDimension; } }
//		public static int ElementCountLowerTriangleIncDiagonal { get { return RowCount <= ColumnCount ? (RowCount * RowCount + RowCount) / 2 : ElementCount - ElementCountUpperTriangleExcDiagonal; } } 
//		public static int ElementCountUpperTriangleIncDiagonal { get { return RowCount >= ColumnCount ? (ColumnCount * ColumnCount + ColumnCount) / 2 : ElementCount - ElementCountLowerTriangleExcDiagonal; } }
//		public static int ElementCountLowerTriangleExcDiagonal { get { return RowCount <= ColumnCount ? (RowCount * RowCount + RowCount) / 2 : ElementCount - ElementCountUpperTriangleIncDiagonal; } }
//		public static int ElementCountUpperTriangleExcDiagonal { get { return RowCount >= ColumnCount ? (ColumnCount * ColumnCount + ColumnCount) / 2 : ElementCount - ElementCountLowerTriangleIncDiagonal; } }
...
//			Default,
//			Diagonal,
//			UpperTriangleIncDiagonal,
//			UpperTriangleExcDiagonal,
//			LowerTriangleIncDiagonal,
//			LowerTriangleExcDiagonal
//		}

//		readonly T[] _elements;
//		readonly MatrixType _type;

//		public bool IsZero { get { return _elements == null; } }

//		Matrix(T[,] elements, bool copy, MatrixType type)
//		{
//			_type = type;
//			if (elements != null)
//			{
...
//			{
//				for (int col = 0; col < ColumnCount; col++)
//					result[row, col] = a[row, col].Subtract(b[row, col]);
//			}
//			return new Matrix<T, ColDim, RowDim>(result, false);
//		}
...
//			{
//				for (int col = 0; col < ColumnCount; col++)
//					result[row, col] = matrix[row, col].Negate();
//			}
//			return new Matrix<T, ColDim, RowDim>(result, false);
//		}
...
//				T val = new T();
//				for (int col = 0; col < ColumnCount; col++)
//					val = val.Add(matrix[row, col].Multiply(vector[col]));
//				result[row] = val;
//			}
...
//				T val = new T();
//				for (int row = 0; row < RowCount; row++)
//					val = val.Add(matrix[row, col].Multiply(vector[row]));
//				result[col] = val;
//			}
//			return result.ToVector();
//		}

//		public Matrix<T, SameColDim, SameRowDim> To<SameColDim, SameRowDim>()
//			where SameColDim : IDimensionProvider, new()
//			where SameRowDim : IDimensionProvider, new()
//		{
//			if (Matrix<T, SameColDim, SameRowDim>.ColumnDimension != ColumnDimension || Matrix<T, SameColDim, SameRowDim>.RowDimension != RowDimension)
...
//		{
//			if (_elements == null)
//				return new Matrix<TOther, ColDim, RowDim>();
...
//		{
//			if (matrix._elements == null || scalar.IsZero)
...
//			{
//				for (int col = 0; col < ColumnCount; col++)
//					result[row, col] = scalar.Multiply(matrix[row, col]);
//			}
//			return new Matrix<T, ColDim, RowDim>(result, false);
//		}
...
//			{
//				for (int col = 0; col < ColumnCount; col++)
//					result[row, col] = matrix[row, col].Divide(scalar);
//			}
//			return new Matrix<T, ColDim, RowDim>(result, false);
//		}
...
//				{
//					if (!elements.Equals(Scalar<T>.Zero))
//						return false;
//				}
//			}
//			else
...
//					for (int col = 0; col < ColumnCount; col++)
//					{
//						if (!a._elements[row, col].Equals(b._elements[row, col]))
//							return false;
//					}
//				}
//			}
...
//	{
//		public static Matrix<T, Dim, Dim> GetDiagonal<T, Dim>(params T[] diagonalElements)
//			where T : struct, IScalar<T>
...
//		public static Matrix<DoubleScalar, D3,D3> GetRotationX(Radians rad)
//		{
//			var builder = new Matrix<DoubleScalar, D3, D3>.Builder();
//			double sin = rad.Sin();
//			double cos = rad.Cos();
//			builder[0, 0] = 1.0;
//			builder[1, 1] = cos;
...
//		public static Matrix<DoubleScalar, D3, D3> GetRotationY(Radians rad)
//		{
//			var builder = new Matrix<DoubleScalar, D3, D3>.Builder();
//			double sin = rad.Sin();
//			double cos = rad.Cos();
...
//		public static Matrix<DoubleScalar, D3, D3> GetRotationZ(Radians rad)
//		{
//			var builder = new Matrix<DoubleScalar, D3, D3>.Builder();
//			double sin = rad.Sin();
//			double cos = rad.Cos();
...
//		public static Matrix<DoubleScalar,D3,D3> GetRotationEulerZXZ(Radians alpha, Radians beta, Radians gamma)
//		{
...
//		public static Matrix<DoubleScalar, D3, D3> GetRotationEulerZYZ(Radians alpha, Radians beta, Radians gamma)
//		{
//			double aSin = alpha.Sin();
//			double aCos = alpha.Cos();
//			double bSin = beta.Sin();
...
//		public static Matrix<DoubleScalar,D3,D3> GetRotation(Vector<DoubleScalar,D3> axisDirection, Radians phi)
//		{
...
//					{
//						val = val.Add(a[row, d].Multiply(b[d, col]));
//					}
//					result[row, col] = val;
//				}
//			}
